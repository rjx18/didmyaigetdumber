...
| P3. Overall / By-model switch | `frontend-p3-overall-by-model` | complete | phase commit | Segmented toggle; aggregate vs per-model overlay. |
| P4. Rate-limit remaining-led cards | `frontend-p4-rate-limit-remaining` | complete | phase commit | %-remaining headline, exhaustion alert, used-up → reset. |
